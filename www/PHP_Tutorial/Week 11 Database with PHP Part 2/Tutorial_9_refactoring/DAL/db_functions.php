...
function insertBranch($strBranch_Code, $strBranch_name, $strManager, $strBranch_Address, $strSuburb, $strState, $intPost_code, $strPhone, $strFax) {
...
function updateBranch($strBranch_Code, $strBranch_name, $strManager, $strBranch_Address, $strSuburb, $strState, $strPost_code, $strPhone, $strFax) {
	global $dbConnection, $stmt;
	connect();
